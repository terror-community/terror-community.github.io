...
function card(name, rank, profile) {
    ...
    return /* html */`
        <div class="flex flex-row sm:justify-center space-x-6 py-4 lg:py-6 px-6 hover:cursor-pointer group transition duration-200 bg-black/20 border-2 border-white/5 backdrop-blur-sm rounded-xl"> <!--card-->
            ...
            <div class="sm:text-center space-y-1 max-w-48 flex-col flex items-center">
                ...
                <h1 class="mb-1 text-lg lg:text-2xl text-white truncate w-full">${name}</h1>
                <div class="rank flex sm:justify-center"><p class="w-fit px-3 rounded-full truncate ${ranktype}">${rank}</p></div>
